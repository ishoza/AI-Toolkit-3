...
class _ImageFeatureState extends State<ImageFeature> {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
              height: nq.height * .5,
              margin: EdgeInsets.symmetric(vertical: nq.height * .015),
          ...
          Obx(() => _c.imageList.isEmpty
              ...
              : SingleChildScrollView(
                  ...
                  padding: EdgeInsets.only(bottom: nq.height * .03),
                  physics: const BouncingScrollPhysics(),
                  child: Wrap(
                    spacing: 10,
  ...
  Widget _aiImage() => ClipRRect(
        ...
        child: switch (_c.status.value) {
          Status.none =>
            Lottie.asset('assets/lottie/ai_play.json', height: nq.height * .3),
