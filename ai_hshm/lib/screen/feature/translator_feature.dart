import 'package:ai_hshm/controller/image_controller.dart';
...
import 'package:ai_hshm/widget/language_sheet.dart';
...
class _TranslatorFeatureState extends State<TranslatorFeature> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        padding: EdgeInsets.only(top: nq.height * .02, bottom: nq.height * .1),
        children: [
          ...
          Padding(
            padding: EdgeInsets.symmetric(
                horizontal: nq.width * .04, vertical: nq.height * .035),
            child: TextFormField(
              controller: _c.textC,
              minLines: 5,
              maxLines: null,
  ...
  Widget _translateResult() => switch (_c.status.value) {
        ...
        Status.complete => Padding(
            padding: EdgeInsets.symmetric(horizontal: nq.width * .04),
            child: TextFormField(
